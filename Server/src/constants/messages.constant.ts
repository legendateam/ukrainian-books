...
export const messagesConstant = {
    [MessagesEnum.AFTER_SENT_MESSAGE_ON_EMAIL]: `
        Ми відправили вам повідомлення з подальшими інструкціями на ваш електронний адрес,
    ...
    [MessagesEnum.CHANGE_PASSWORD]: `
        Пароль було усмішно змінено! 
   `,
};
